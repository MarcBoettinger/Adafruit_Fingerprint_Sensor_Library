...
uint16_t Adafruit_Fingerprint::led_control(uint8_t control_code, uint8_t speed, uint8_t color_idx, uint8_t times) {
    SEND_CMD_PACKET(FINGERPRINT_LED_CONTROL, control_code, speed, color_idx, times);
